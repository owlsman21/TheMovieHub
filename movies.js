...
// This array will hold all your movie data
    ...
    },
    {
     ...
     },
     {
      ...
      {
        id: 'Staying-Alive',
        posterUrl:  'images/Staying Alive.jpg',
        year: 1983,
        title: "Staying Alive 1983",
        description: "Five years later, Tony Manero's Saturday Night Fever is still burning. Now he's strutting toward his biggest challenge yet: succeeding as a dancer on the Broadway stage.",
        embedId: "2743232301708",
        genres: ["Drama"],
        source: "okru"
     },
      {
        id: 'Grease',
        posterUrl:  'images/Grease.jpg',
        year: 1978,
        title: "Grease 1978",
        ...
        embedId: "7631759018722",
        genres: ["Drama","Comedy"],
        source: "okru"
     },
      {
        id: 'The-Searchers',
        posterUrl:  'images/The Searchers.jpg',
        year: 1956,
     ...
     },
      {
        ...
        embedId: "9369180377506",
        genres: ["Western"],
        source: "okru"
     },
      {
        id: 'Dances-With-Wolves',
        posterUrl:  'images/Dances with Wolves.jpg',
        year: 1990,
        title: "Dances With Wolves 1990",
        description: "A lieutenant assigned to a remote Civil War outpost starts questioning his purpose after making contact with a neighboring Sioux settlement.",
        embedId: "9289789606562",
        genres: ["Western"],
        source: "okru"
     },
      {
        id: 'Under-Siege',
        posterUrl:  'images/Under Siege.jpg',
        year: 1992,
        title: "Under Siege (1992)",
        description: "Ex US Navy Seal turned cook, Casey Ryback, is the only person who can stop a group of terrorists when they seize control of the US battleship The Missouri to obtain it's nuclear warheads",
        embedId: "9569543522990",
        genres: ["Action"],
        source: "okru"
     },
      {
        id: 'Under-Siege-2',
        posterUrl:  'images/Under Siege 2.jpg',
        year: 1995,
        title: "Under Siege 2 Dark Territory(1995)",
        description: "Casey Ryback, is on vacation, with his recently orphaned niece to attend his brothers funeral by train but when terrorists hijack it, to use as a mobile base to hack a top secret destructive US satellite, Ryback must stop them.",
        embedId: "9569632651950",
        genres: ["Action"],
        source: "okru"
     },
      {
        id: 'A-Kind-of-Madness',
        posterUrl:  'images/A Kind of Madness.jpg',
        year: 2025,
        title: "A Kind of Madness (2025)",
        description: "A 70-year-old man kidnaps his wife with dementia from her care facility fleeing from police and their grown children",
        embedId: "9572628171302",
        genres: ["Drama"],
        source: "okru"
     },
      {
        id: 'Echo Valley',
        posterUrl:  'images/Echo Valley.jpg',
        year: 2025,
        title: "Echo Valley 2025",
        description: "Kate is dealing with a personal tragedy while owning and training horses in Echo Valley, an isolated and picturesque place, when her daughter, Claire, arrives at her doorstep, frightened, trembling and covered in someone else's blood",

        embedId: "9572607330854",
        genres: ["Thriller"],
        source: "okru"
     },
      {
        id: 'Diablo',
        posterUrl:  'images/Diablo.jpg',
        year: 2025,
        title: "Diablo 2025",
        ...
        embedId: "9572578953766",
        genres: ["Action","Thriller"],
        source: "okru"
     },
      {
        id: 'Reaper',
        posterUrl:  'images/Reaper.jpg',
        year: 2014,
        title: "Reaper (2014)",
        description: "Criminals and a beautiful but cunning hitchhiker battle a supernatural force known as the Reaper",
        embedId: "9568061098534",
        genres: ["Horror"],
        source: "okru"
     },
      {
